...
----  For example: sampling summaries in Esperanto with copy actions (i.e. property placeholders) a beam size of 3 for the triples 
----  in the Esperanto test set will create the following file: 
----  "./checkpoints/eo/without_property_placeholders/surf_form_tuples.model.t7.summaries_Testing.beam_3.h5".
----
...
local beam_sampling_params = {
    checkpoint = './checkpoints/ar/without_property_placeholders/surf_form_tuples.model.t7', -- The filepath to the saved pre-trained model.
    -- checkpoint = './checkpoints/eo/without_property_placeholders/surf_form_tuples.model.t7', -- The filepath to the saved pre-trained model.
    -- checkpoint = './checkpoints/ar/with_property_placeholders/surf_form_tuples.model.t7', -- The filepath to the saved pre-trained model.
    -- checkpoint = './checkpoints/eo/with_property_placeholders/surf_form_tuples.model.t7', -- The filepath to the saved pre-trained model.
    -- IMPORTANT: Make sure that the dataset that will be loaded matches the specification of the pre-trained model.
    dataset_path = '../Datasets/ar/without_property_placeholders/', -- The path to the folder with all the required dataset-related files.
    -- dataset_path = '../Datasets/eo/without_property_placeholders/', -- The path to the folder with all the required dataset-related files.
    -- dataset_path = '../Datasets/ar/with_property_placeholders/', -- The path to the folder with all the required dataset-related files.
    -- dataset_path = '../Datasets/eo/with_property_placeholders/', -- The path to the folder with all the required dataset-related files.
    beam_size = 20, -- Sets the beam size that will be used during decoding.
